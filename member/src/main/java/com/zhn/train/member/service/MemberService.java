...
public class MemberService {
    ...
    public MemberLoginResp login(MemberLoginReq req) {
        ...
        String key = "coder12306";
        String token = JWTUtil.createToken(map, key.getBytes());
        JWTUtil.createToken(map,key.getBytes());
