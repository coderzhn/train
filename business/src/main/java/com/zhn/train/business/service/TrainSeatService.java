...
import com.zhn.train.business.domain.TrainSeatExample;
import com.zhn.train.business.enums.SeatColEnum;
import com.zhn.train.business.mapper.TrainSeatMapper;
...
public class TrainSeatService {
    ...
    public void genTrainSeat(String trainCode){
        ...
        TrainSeatExample.Criteria criteria = seatExample.createCriteria();
        criteria.andTrainCodeEqualTo(trainCode);
        trainSeatMapper.deleteByExample(seatExample);
        //查找当前车次下的所有车厢
        ...
        for(TrainCarriage trainCarriage:carriageList){
            ...
            LOG.info("当前车次下的车厢数:{}",colsByType.size());
            //循环行数
