package com.zhn.train.${module}.service;
...
import com.zhn.train.${module}.domain.${Domain};
import com.zhn.train.${module}.domain.${Domain}Example;
import com.zhn.train.${module}.mapper.${Domain}Mapper;
